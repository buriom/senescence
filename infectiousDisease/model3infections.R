...
#********************************* data fitting ******************************
.args <- c("infectiousDisease/corona.csv","infectiousDisease/fits/model3fits/corona.rds")
...
inits <- list(mu=34.5194, tau=0.000562692, delta = 0.00161717); a <- c(0,0.00005,0.00005); b <- c(100,1, 1)
...
cancer <- gsub(".*infectiousDisease/\\s*|.csv*", "", .args[1])
