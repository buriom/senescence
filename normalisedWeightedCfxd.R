#*******************************************************************************
#In this implementation, I fitted 2 parameters, i.e beta and  mu, with C fixed
#*******************************************************************************
library("minpack.lm")

prs <- list(
  delta = 0.0015, h=50, n=1, C=0.0017, a=1/(33.33 *365)#fixed paramaters
)
...
plot(age, obs,  col = "blue",
     xlab = "Age", ylab = expression('log'[10]*' Incidence'), main = "Stomach Cancer Data with C fixed")
lines(age, preds)
